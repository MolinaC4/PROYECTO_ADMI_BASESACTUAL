				...
				<form method="post" enctype="multipart/form-data">	
				 <nav class="nav-extended">
				    <div class="nav-wrapper">
				      <a href="periodos.php" class="brand-logo">FinancieroCR - Endeudamiento</a>
				      <a href="periodos.php" data-activates="mobile-demo" class="button-collapse"><i class="material-icons">menu</i></a>
